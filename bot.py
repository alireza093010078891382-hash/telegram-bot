...
# ---------- بخش دعوت دوستان (Referral Menu Handler) ----------
...
async def handle_steps(message: Message):
    ...
    # ۱. بخش بازیابی حساب با ۱۵ کلمه (فراموشی حساب)
    ...
    if state == "get_username":
        ...
        # انتخاب تصادفی ۱۵ کلمه از لیست ۳۰ کلمه‌ای
